...
<body class="antialiased bg-gray-50 text-gray-800">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20 items-center">
                <div class="flex-shrink-0 flex items-center gap-3">
                    <div class="bg-blue-600 text-white p-2 rounded-xl shadow-lg shadow-blue-500/30">
                        ...
                        <svg viewBox="0 0 24 24" fill="none" class="w-8 h-8" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M16 2V5" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M3.5 9.09H20.5" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path
                    ...
                    <span class="font-extrabold text-2xl text-gray-800 tracking-tight">Studio<span
                        ...
                        @else
                            ...
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}"
                                    class="bg-blue-600 text-white px-6 py-2.5 rounded-full font-bold hover:bg-blue-700 transition shadow-lg shadow-blue-500/30 hover:-translate-y-1 transform">Daftar
                                    Sekarang</a>
                            @endif
                        @endauth
                    @endif
    ...
    <div
        class="relative bg-gradient-to-br from-blue-700 via-indigo-700 to-blue-900 text-white pt-40 pb-32 px-6 overflow-hidden">
        <div
            class="absolute top-20 right-0 -mt-20 -mr-20 w-96 h-96 bg-white opacity-10 rounded-full blur-3xl animate-pulse">
        </div>
        <div
            class="absolute bottom-0 left-0 -mb-20 -ml-20 w-80 h-80 bg-blue-400 opacity-10 rounded-full blur-3xl animate-float">
        </div>

        <div class="max-w-4xl mx-auto text-center relative z-10">
            <span
                class="bg-blue-500/30 text-blue-100 px-6 py-2 rounded-full text-sm font-bold mb-8 inline-flex items-center gap-2 backdrop-blur-md border border-blue-400/30 shadow-lg">
            ...
            <h1 class="text-5xl md:text-7xl font-extrabold mb-8 leading-tight tracking-tight drop-shadow-lg">
                Kelola Jadwal & Sewa <br> <span
                    class="text-transparent bg-clip-text bg-gradient-to-r from-blue-200 to-white">Ruangan Lebih
                    Mudah</span>
            </h1>
            <p class="text-xl md:text-2xl text-blue-100 mb-12 max-w-2xl mx-auto leading-relaxed">
                Booking Studio Musik, Lapangan Futsal, atau Ruang Meeting kapan saja. Tanpa ribet, langsung dikonfirmasi
                otomatis.
            </p>
    ...
    <div id="services" class="py-24 bg-gray-50">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                <!-- Card 1 -->
                <div
                    class="bg-white p-10 rounded-3xl shadow-sm hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
                    <div
                    ...
                    <h3 class="text-2xl font-bold text-gray-800 mb-4 group-hover:text-purple-600 transition">Studio
                        Musik</h3>
                    <p class="text-gray-500 leading-relaxed">Peralatan lengkap, kedap suara, dan sound system premium
                        untuk latihan band profesional.</p>
                </div>
                ...
                <div
                    ...
                    <h3 class="text-2xl font-bold text-gray-800 mb-4 group-hover:text-green-600 transition">Lapangan
                        Futsal</h3>
                    <p class="text-gray-500 leading-relaxed">Rumput sintetis standar FIFA, pencahayaan optimal, dan
                        fasilitas kamar ganti bersih.</p>
                </div>
                ...
                <div
                    ...
                    <h3 class="text-2xl font-bold text-gray-800 mb-4 group-hover:text-blue-600 transition">Ruang Meeting
                    </h3>
                    <p class="text-gray-500 leading-relaxed">Dilengkapi Proyektor HD, AC dingin, dan whiteboard. Cocok
                        untuk rapat tim atau workshop.</p>
                </div>
            </div>
        </div>
    </div>
